...
| Remote graph client and asynchronous hosted subagents | deferred | separate module candidate |
...
- Remote asynchronous subagents, hosted graph clients, video decoding, and tracing
  integrations remain separate optional work and are not core parity requirements.
